...
public class Mp3LibraryView {
    ...
    public String printMenuAndGetSelection() {
        ...
        io.print("6. Exit");
        io.print("7. Search Database by Genre");

        return io.readString("Please select from the above choices. 1 Through 7.");
    }
    ...
    public void displayMp3ByGenre() {
        io.print("=== Mp3 by Genre ===");
    }
    ...
    public String getGenreChoice() {
        return io.readString("Please Enter The Genre Of Mp3's.");
    }
